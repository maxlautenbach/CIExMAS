...
from results.C_Error_Incorporation.Gen1_PredEx.setup import cIEState
from results.C_Error_Incorporation.Gen1_PredEx.agents.agent_instructor import agent as agent_instructor_agent
from results.C_Error_Incorporation.Gen1_PredEx.agents.entity_extractor import agent as entity_extraction_agent
from results.C_Error_Incorporation.Gen1_PredEx.agents.predicate_extractor import agent as predicate_extraction_agent
from results.C_Error_Incorporation.Gen1_PredEx.agents.triple_extractor import agent as triple_extraction_agent
from results.C_Error_Incorporation.Gen1_PredEx.agents.uri_detector import agent as uri_detection_agent
from results.C_Error_Incorporation.Gen1_PredEx.agents.result_checker import agent as result_checker_agent
from results.C_Error_Incorporation.Gen1_PredEx.agents.result_formatter import agent as result_formatting_agent
from results.C_Error_Incorporation.Gen1_PredEx.agents.planner import agent as planner
...
for i in tqdm(range(len(docs))):
    ...
    try:
        response = graph.invoke({"text": text, "results": [], "call_trace": [], "comments": [], "debug": False},
                            config={"run_id": trace_id, "recursion_limit": 70, "callbacks": [langfuse_handler], "tags":["C_Error_Incorporation_Gen1_PredEx", f'{os.getenv("LLM_MODEL_PROVIDER")}-{os.getenv("LLM_MODEL_ID")}']})
...
excel_file_path = f"{repo.working_dir}/results/result_evaluation_logs/C_Error_Incorporation_Gen1_PredEx.xlsx"
try:
